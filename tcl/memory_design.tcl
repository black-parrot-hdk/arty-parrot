...
# If there is no project opened, this script will do nothing
...
set proj_obj [current_project -quiet]
...
proc write_mig_file_memory_design_mig_ddr_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>memory_design_mig_ddr_0</ModuleName>}
   ...
   puts $mig_prj_file {    <MMCMClkOut1>9</MMCMClkOut1>}
   puts $mig_prj_file {    <MMCMClkOut2>18</MMCMClkOut2>}
   puts $mig_prj_file {    <MMCMClkOut3>37</MMCMClkOut3>}
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_111M_o [ create_bd_port -dir O -type clk clk_111M_o ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {111000000} \
 ] $clk_111M_o
  ...
  # Create instance: rst_s_axi, and set properties
  set rst_s_axi [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_s_axi ]
  set_property -dict [ list \
   CONFIG.RESET_BOARD_INTERFACE {reset} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $rst_s_axi
  ...
  connect_bd_net -net rst_s_axi_20M_interconnect_aresetn [get_bd_ports s_axi_reset_n_o] [get_bd_pins axi_clock_converter_0/s_axi_aresetn] [get_bd_pins rst_s_axi/interconnect_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports external_clock_i] [get_bd_pins ddr_clocks/clk_in1]
  connect_bd_net -net sys_reset_mb_reset [get_bd_ports proc_reset_o] [get_bd_pins rst_s_axi/mb_reset]
  connect_bd_net -net tie_high_dout [get_bd_pins rst_mig_ddr_83M/aux_reset_in] [get_bd_pins rst_s_axi/aux_reset_in] [get_bd_pins rst_tie_high/dout]
  connect_bd_net -net tie_low_dout [get_bd_pins rst_mig_ddr_83M/mb_debug_sys_rst] [get_bd_pins rst_s_axi/mb_debug_sys_rst] [get_bd_pins rst_tie_low/dout]
  ...
  puts "$bd_file"
  # TODO: should this be autogenerated, or should updating it require user to load BD, save wrapper
  # and then save in src/v of repo?
  set wrapper_file [make_wrapper -files $bd_file -top]
  puts "adding wrapper file to sources_1: ${wrapper_file}\n"
