...
## USB-UART Interface
## NOTE: uart_rxd_out connects pin D10 as output from FPGA to FTDI FT2232 USB-UART bridge (i.e., use it as tx_out from FPGA)
## NOTE: uart_txd_in connects pin A9 as input from FTDI FT2232 USB-UART bridge to FPGA (i.e., use it as rx_in to FPGA)
## see schematic here: https://reference.digilentinc.com/reference/programmable-logic/arty-a7/reference-manual#usb-uart_bridge_serial_port
