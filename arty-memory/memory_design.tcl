...
# source memory_design.tcl

# If there is no project opened, this script will create a
# project, but make sure you do not have an existing project
# <./$project_dir/$project_name.xpr> in the current working folder.

variable project_name
set project_name arty_memory
...
proc write_mig_prj_file { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>memory_design_mig_7series_0_2</ModuleName>}
